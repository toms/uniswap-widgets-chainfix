              ...
              if (valid0) {
                ...
                if (valid0) {
                  if (data.tokenMap !== undefined) {
                    ...
                    if (errors === _errs19) {
                      if (data8 && _typeof__default["default"](data8) == "object" && !Array.isArray(data8)) {
                  ...
                  if (valid0) {
                    ...
                    if (valid0) {
                      if (data.tags !== undefined) {
                        ...
                        if (errors === _errs29) {
                          if (data12 && _typeof__default["default"](data12) == "object" && !Array.isArray(data12)) {
                            if (Object.keys(data12).length > 20) {
                              ...
                              if (valid8) {
                                for (var key5 in data12) {
                                  ...
                                  if (errors === _errs36) {
                                    if (data13 && _typeof__default["default"](data13) == "object" && !Array.isArray(data13)) {
                                      var missing2 = void 0;
